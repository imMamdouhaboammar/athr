...
The first required bootstrap step is:

```bash
npx @21st-dev/cli install-skill
```

The active coding agent must have the 21st skills installed, then use 21st through MCP or CLI to search existing components, screens, templates, and themes before creating custom UI
...
- UI work: first run the 21st skills bootstrap and follow [docs/agents/21ST_AGENT_SETUP.md](docs/agents/21ST_AGENT_SETUP.md) and [docs/components/21ST_COMPONENT_WORKFLOW.md](docs/components/21ST_COMPONENT_WORKFLOW.md), then [docs/design/DESIGN_SYSTEM.md](docs/design/DESIGN_SYSTEM.md), [docs/design/VISUAL_DIRECTION.md](docs/design/VISUAL_DIRECTION.md), and [docs/components/README.md](docs/components/README.md)
